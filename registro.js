...
function renderAdmin(){
  ...
  c.innerHTML = `
    ...
    <div class="card" id="migracion_card">
      ...
      <div class="note">Trae a los 27 participantes del sistema anterior (los que predijeron por Excel/PDF antes de que existiera este formulario) para que aparezcan acá, en el Ranking y en Estadísticas — sin tocar ni un punto de lo que ya tienen ganado. Es seguro correrlo más de una vez: a quien ya esté acá, lo salta. Descarga un backup automático antes de escribir nada.</div>
